...
wget -P ./ -T 600 https://download.java.net/openjdk/jdk8u41/ri/openjdk-8u41-b04-linux-x64-14_jan_2020.tar.gz
...
if [ ! -d "/home/ec2-user/java-se-8u41-ri" ]; then
  wget -P ./ https://mirrors.tuna.tsinghua.edu.cn/AdoptOpenJDK/8/jdk/x64/linux/OpenJDK8U-jdk_x64_linux_hotspot_8u292b10.tar.gz
...
wget -P ./ -T 600 https://mirrors.tuna.tsinghua.edu.cn/apache/zookeeper/zookeeper-${1}/apache-zookeeper-${1}-bin.tar.gz
