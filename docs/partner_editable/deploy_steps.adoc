...
[cols="3,1"]
|===
^|https://fwd.aws/N4maE?[Deploy {partner-product-short-name} into a new VPC on AWS^]
^|https://fwd.aws/6QaWE?[View template^]

^|https://fwd.aws/y4mMk?[Deploy {partner-product-short-name} into an existing VPC on AWS^]
^|https://fwd.aws/XynX5?[View template^]
|===
+
