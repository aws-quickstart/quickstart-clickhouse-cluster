...
* Dynamically generate a random text string stored in *Secrets Manager* to use as a password.
...
** When CPU utilization (cpu_usage_user and cpu_usage_system from CloudWatch agent) higher than 70% and continue more than 5 minutes.
** When memory utilization (mem_used_percent from CloudWatch agent) higher than 70% and continue more than 5 minutes.
