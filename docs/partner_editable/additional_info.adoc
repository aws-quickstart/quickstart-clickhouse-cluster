...
[#IPaddress]
[link=images/ClickHouseClientAddress.png]
.EC2 instance private IP address
image::../images/ClickHouseClientAddress.png[ClickHouseClientAddress,width=75%,height=75%]
...
+
:xrefstyle: short
<<webconsole>> shows an example of the Grafana client in the web console.
